...
#define L_TRIGGER pros::E_CONTROLLER_DIGITAL_L1
#define L_BUMPER  pros::E_CONTROLLER_DIGITAL_L2
#define R_TRIGGER pros::E_CONTROLLER_DIGITAL_R1
#define R_BUMPER  pros::E_CONTROLLER_DIGITAL_R2
